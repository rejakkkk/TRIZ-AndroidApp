...
public class parameterind extends AppCompatActivity implements RecyclerViewInterfaceP {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myDB = new DatabaseHelper(parameterind.this);
        id_p = new ArrayList<>();
        ...
        adapterRecycleViewp = new adapterRecycleViewp(parameterind.this, id_p, nama_p,meaningP,saeP, this);
        recyclerView.setAdapter(adapterRecycleViewp);
        recyclerView.setLayoutManager(new LinearLayoutManager(parameterind.this));
    ...
    public void onItemClick(int id, String nama, String meaning, String sae) {
        Intent intent = new Intent(parameterind.this, penjelasanparameterind.class);
